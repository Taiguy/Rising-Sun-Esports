...
//             '<div class="list-RSname col-12 col-sm-3"><h6>Rising Sun Esports '+matches[i].region+'</h6></div>'+
//             '<div class="list-RSlogo col-12 col-sm-1"><img class="teamLogo" src="rs-logo1.png" alt="Rising Sun Esports"></div>'+
...
for(i = 0; i < matches.length; i++){ 
    $('.scoreboardList').append(
        '<div class="row">' +
            ...
            '<div class="score col-2"><div><h6>'+matches[i].score+'</h6></div></div>'+
